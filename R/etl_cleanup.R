...
#' @rdname etl_create
#' @param delete_raw should files be deleted from the `raw_dir`?
#' @param delete_load should files be deleted from the `load_dir`?
#' @param pattern regular expression matching file names to be deleted. By default,
#' this matches filenames ending in `.csv` and `.zip`.
#' @export
