...
if (!require(airlines)) {
  if (require(devtools)) {
    ...
    warning("Examples require the airlines package")
  }
}
...
Note that an `etl_foo` object is also a `src_dbi` object and a `src_sql` object. Please see the [`dbplyr` vignette](https://cran.r-project.org/web/packages/dbplyr/index.html) for more information about these database connections. 
